...
**Agent behaviour:**
Reads CLAUDE.md → repo=`[your-org]/[your-repo]`, gcp=`[your-gcp-project]`.
...
existed out-of-band. Fix: add import block to secrets.tf."
Logs the failure entry — does NOT skip because it was a failure.

**User:** `/secret-manager-journal` (new project, first action)

**Agent behaviour:**
Reads journal file — finds no section for `[your-org]/[your-repo]`.
Creates new `## Project Journal — [your-org]/[your-repo]` section with GCP project header.
