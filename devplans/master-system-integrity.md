...
- **אבחון-תמונה צד-פקטורי (חסם CI עקיפה):** ה-CI של or-edri-4 נחנק (אין הרצות אחרי 09:22), אז גם החלת B8 חי וגם diag-vision חסומים. הפקטורי-CI עובד → `diag-vision-oredri4.yml` (זמני, registry-exempt) רץ על הפקטורי, קורא את openrouter-api-key של or-edri-4 דרך הברוקר, ומשחזר את קריאת ה-VLM לתפיסת השגיאה הגולמית.
