...
**Acceptance:**
- [x] **החסימה שוחררה (2026-06-10):** ‏`n8n-2x-upgrade` (done) העלה את התבנית ל-2.25.7 —
      התלות (Wait בתוך sub-workflow ב-1.121) נסגרה. ה-async deep-research יכול להיבחן
      כ-follow-up נפרד על מערכות חדשות (2.25.7).

**הערת התקדמות אחרונה (2026-06-10):** היה נדחה ביודעין כי המנגנון האסינכרוני שבור עד
n8n 2.0; ‏`n8n-2x-upgrade` שחרר את החסימה — מערכות חדשות על 2.25.7. ה-async deep-research
הוא follow-up עתידי נפרד.
