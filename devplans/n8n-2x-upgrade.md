...
| 3 | מיזוג + הוכחת לידה Day-0: provision טרי על 2.25.7 | in-progress | מערכת-טסט שנייה (reuse mode) |
...
**הערת התקדמות אחרונה (2026-06-10):** Or אישר מיזוג + provision טרי. ‏PR ‎#375 (שלבים
1–2) ירוק על כל 5 הבדיקות — נמזג ל-main. אחרי המיזוג: ‏provision של מערכת-טסט שנייה
מ-main (reuse mode, ‏0 מכסה) להוכחת לידת Day-0 על 2.25.7.
