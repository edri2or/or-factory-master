...
| 3 | שער-סיכון GCP + גשר אישור טלגרם | in-progress (קוד נכתב, ממתין ל-deploy+אימות חי) | `.github/workflows/gcp-action.yml`, `services/mcp-server/src/gcp-approval.ts`, `index.ts` |
