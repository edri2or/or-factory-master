...
| 2 | הוכחה: code-agent כתיקייה | pending | `templates/system/agents/code/**` |
...
**Acceptance:**
- [ ] קיים `templates/system/agents/code/` (`agent.yaml`+`instructions.md`+`tools.yaml`)
      המייצג את ה-code-agent הקיים.
- [ ] התיקייה תקפה מול הסכמות משלב 1 (בדיקה ידנית; השער האוטומטי בא בשלב 4).
