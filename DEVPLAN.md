...
PR. לעולם לא ממזג (שלב 4-5). שער-הבטיחות נבדק מקומית ב-6 תרחישים; אימות-ההסלמה החי על main אחרי המיזוג. **אימות חי של נתיב פתיחת-ה-PR-טיוטה מתבצע כעת** (פיגום זמני `scripts/oil-selftest-draftpr.sh`; יוסר בסיום — main ללא שינוי).
