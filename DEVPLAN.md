...
- 2026-05-29 · **Stage 133** — זהות סוכן לכל מערכת ב-`AGENTS.md` (כרטיס מפעיל קבוע + שדה `system_purpose` + שם סוכן אוטומטי). שינוי פקטורי עצמאי; הפירוט המלא ב-`CHANGELOG.md`.
