...
- `ORG` — GitHub organization name (e.g., `[your-org]`)
- `CENTRAL_REPO` — the central skills repo (e.g., the repo name portion of `[your-central-repo]`)
...
Structure of the reusable workflow (see working reference: `[your-central-repo]/.github/workflows/skill-sync-reusable.yml`):
...
Structure (see working reference: `[your-central-repo]/.github/workflows/auto-merge-sync.yml`):
...
Structure of the distribute workflow (see working reference: `[your-central-repo]/.github/workflows/distribute-skills.yml`):
